...
from lib.model import PVT_MSI_LE_CASCADE
...
parser.add_argument('--max_epochs', type=int,
                    default=400, help='maximum epoch number to train')  # 150
...
if __name__ == "__main__":
    ...
    args.exp = 'milenet_' + dataset_name + str(args.img_size)
    snapshot_path = "model_pth/{}/{}".format(args.exp, 'milenet')
    ...
    snapshot_path = snapshot_path + '_dense_simple'
    ...
    net = PVT_MSI_LE_CASCADE(n_class=config_vit.n_classes, connect_way='dense_simple').cuda()
